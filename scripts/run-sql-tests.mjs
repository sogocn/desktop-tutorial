...
const suites = ['db/tests/test_expand.sql', 'db/tests/test_signin.sql', 'db/tests/test_parent_multiusers.sql', 'db/tests/test_checkin_012.sql', 'db/tests/test_shop_badges_013.sql', 'db/tests/test_no_pin_ops_014.sql']
